...
// import '../screens/user/main_layout.dart'; // [DECOUPLED]
// import '../screens/admin/admin_main_layout.dart'; // [DECOUPLED]
// import '../screens/user/products/submit_review_screen.dart'; // [DECOUPLED]
...
class PushNotificationService {
  ...
  static Future<void> initialize() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      // [NEW] Trigger native Web Audio Ping 
      if (kIsWeb) {
    ...
    await _localNotificationsPlugin.initialize(
      ...
      onDidReceiveNotificationResponse: (NotificationResponse response) async {
        ...
        if (role == 'admin') {
          debugPrint("Push Notification: Navigate to Admin Orders");
          // Navigation logic should be handled by the app-specific implementation or Navigator.pushNamed
        } else {
          debugPrint("Push Notification: Navigate to User Orders");
        }
      },
    );
        ...
        */
        ...
        try {
          ...
          if (role == 'admin') {
             ...
             */
             debugPrint("Admin Deep Link: $status");
          } else {
             /*
             Navigator.of(context).pushAndRemoveUntil(
             ...
             */
             debugPrint("User Deep Link: $status");
          }
        } catch (e) {
        ...
        if (productId != null && orderId != null) {
          ...
          */
          debugPrint("Review Deep Link: $productId");
          } catch (e) {
