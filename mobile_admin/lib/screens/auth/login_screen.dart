...
import 'package:clotheline_admin/widgets/branding/WashingMachineLogo.dart';
    ...
    try {
      ...
      if (!mounted) return;
        if (user['role'] == 'admin') {
           ...
           ToastUtils.show(context, "Unauthorized access. Staff credentials required.", type: ToastType.error);
        }
    } catch (e) {
      if (!mounted) return;
